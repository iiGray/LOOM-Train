...
from loomtrain.trainer import SimPOTrainerConfig, SimPOTrainer
from loomtrain.modeling import GPT
from loomtrain.dataset import PreferenceDataset, BlendedPreferenceDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--rejected-key", type = str, default = "reject"
    )
    parser.add_argument(
        "--num-rejects", type = int, default = 1
    )
    parser.add_argument(
        "--simpo-gamma", type = float, default = 0.5
    )
    parser.add_argument(
        "--simpo-beta", type = float, default = 2.5
    )
    parser.add_argument(
        "--simpo-nll-loss-weight", type = float, default = 0.0
    )
