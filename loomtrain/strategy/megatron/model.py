...
# This is a revision of megatron.core.models.gpt.GPTModel, excluding the loss part
# currently not supporting MTP and VP stage
class MegatronGPT(LanguageModule):
    ...
    def __init__(
        ...
        mtp_block_spec: Optional[ModuleSpec] = None, # if is none, the not applying mtp
    ...
    def forward(
        ...
        *,
        ...
        It either returns the logs values if labels are given  or the final hidden units
    ...
    def _postprocess(
        ...
        if mtp_in_postprocess:
            hidden_states = self.mtp(
                input_ids=input_ids,
                position_ids=position_ids,
                # labels=labels, # TODO: del labels in mtp forward 
                loss_mask=loss_mask,
                hidden_states=hidden_states,
                attention_mask=attention_mask,
                inference_params=inference_params,
        ...
        return logits.transpose(0, 1).contiguous() # [s, b, h]
